...
export const SearchTextView = ({ height, width, text }) => {
    return (
        <View style={{borderWidth:1, borderRadius:30, borderColor: '#bcbcbcff', width:width, flexDirection:'row', alignItems:'center', paddingLeft:20, height:50}}>
